      ...
      <div id="shipping-address" class="panel panel-default">
        ...
        <div id="shipping-address-content" class="panel-collapse collapse in">
          <div class="panel-body row">
            <div class="col-md-3 col-sm-6 order_left">
                ...
                // dd($this->data['cart'][$key]->name);
                  foreach ($this->data['cart'] as $key => $value) { ?>
                      ...
                      <tr>
                        ...
                        <?php if($value->price!=""){ 
                            echo "<td class='checkout-price'>".number_format($value->price,0,'','.')."</td>";?> VNĐ
                            <?php }else{echo "<td class='checkout-price'>Lien He</td>";} ?>
                        <td class="checkout-total"><strong><span></span><?php echo number_format($value->total,0,'','.'); ?> VNĐ</strong></td>
                      </tr>
