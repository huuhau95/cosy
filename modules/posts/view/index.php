...
<div class="container">
    <p style="padding: 10px 0 0 30px; font-size: 18px;"><a href="<?php echo base_url(); ?>">Trang Chủ ></a> <?php echo $this->data['menu']['title'] ?></p>
    <div class="col-sm-8">
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <h4 class="h4tinmoi">TIN MỚI</h4>
            <?php
if (!empty($this->data['data'])) {
	foreach ($this->data['data'] as $key => $posts) {
		?>
	...
	foreach ($this->data['voucher'] as $key => $voucher) {
		?>
                                 <li>
                                    ...
                                    <p><i class="glyphicon glyphicon-time"></i> <?php echo date('d-m-Y', $voucher['create_time']) ?></p>
                                </li>
                            <?php
}
}
