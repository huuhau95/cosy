...
if (!function_exists('getImagesToFolder')){
        function getImagesToFolder($dir){
            $ImagesArray = [];
            $file_display = ['jpg', 'jpeg', 'png', 'ico', 'gif','mp4','pdf','txt','doc','docx','xlsx','xls','pptx','pot','zip','rar','mp4','mpg','wma','mov','flv','mp4','qt','wmv','wmv'];
                    ...
                    if ($dir!=$root) {
                      ...
                      if (is_dir($dir.$value)) {
                            ...
                            $html .= "<div class='text-center overcontrol'>
                                    <a style='display:none' href='javascript:void(0)' class='rename' data-title='".$value."'><i class='fa fa-font' aria-hidden='true'></i></a>
                            ...
                            $html .= "<div class='overflow'><a class='fancybox' href='".base_url()."cdn/".$current.$value."'><i class='icon-zoom-in'>&#xe801;</i></a></div>";
                            ...
                            $html .= "<div class='text-center' style='display:none'>".$value."</div>";
                            $html .= "<div class='text-center overcontrol'>
                                    <a href='javascript:void(0)' style='display:none' class='rename' data-title='".$value."'><i class='fa fa-font' aria-hidden='true'></i></a>
                                    <a href='javascript:void(0)' class='delete' data-title='".$value."'><i class='fa fa-trash-o' aria-hidden='true'></i></a>
                                    </div>";
                            $html .= "</div>";
                        }
                ...
                foreach ($folder_recursive as $key => $value) {
                    ...
                    if ($dir!=$root) {
                      ...
                      if (is_dir($dir.$value)) {
                            ...
                            $html .= "<div class='media-col' data-folder='false'>";
                            $html .= "<div class='overflow'><a class='fancybox' href='".base_url()."files/".$current.$value."'><i class='icon-zoom-in'>&#xe801;</i></a></div>";
