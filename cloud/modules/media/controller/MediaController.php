...
class MediaController extends Controller{
	...
	public function uploadImages(){
		...
		if (isset($_POST)) {
			...
			$dir = trim($_POST['directory']);
			if (isset($_FILES['media'])) {
				$file_display = ['image/jpeg','image/jpeg','image/jpeg','image/gif','image/png','image/bmp','video/x-flv','video/mpeg','video/mpeg','video/mpeg','audio/mpeg3','audio/wav','audio/aiff','audio/aiff','video/msvideo','video/x-ms-wmv','video/quicktime','video/mpg','video/wma','video/mov','video/flv','video/mp4','video/qt','video/wmv','video/avi','application/vnd.ms-powerpoint','application/vnd.ms-excel','application/msword','application/json','application/pdf','text/plain','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.openxmlformats-officedocument.presentationml.presentation','application/vnd.openxmlformats-officedocument.presentationml.slideshow','text/csv','application/zip','application/x-tar','application/octet-stream'];
