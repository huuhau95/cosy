		...
		foreach ($data as $k => $value) {
			if ($value['parent_id'] == $parent) {
				...
				if ($value['parent_id'] == 0) {
					echo "<li><a data-title='" . $value['title'] . "' data-img='" . $value['avatar'] . "' data-alias='" . $value['alias'] . "' data-id='" . $value['id'] . "' href='javascript:void(0)' data-link='" . '/' . $value['alias'] . '-x' . $value['id'] . '.htm' . "'>" . $value['title'] . "</a></li>";
				} else {
					echo "<li><a data-title='" . $value['title'] . "' data-img='" . $value['avatar'] . "' data-alias='" . $value['alias'] . "' data-id='" . $value['id'] . "' href='javascript:void(0)' data-link='" . '/' . $value['alias'] . '-p' . $value['id'] . '.htm' . "'>" . $value['title'] . "</a></li>";
				}
				unset($data[$k]);
