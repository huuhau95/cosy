...
<script type="text/javascript">
  ...
  //   window.location="<?php echo base_url().'users/manager/edit/'.Session::get('id');?>";
  // }
  // function your_account(){
  //   window.location="<?php echo base_url().'users/manager/view/'.Session::get('id');?>"
  // }
</script>
<script>
     $(document).ready(function() {
...
$("#chonthaotac_order").click(function(){
 ...
 //          document.getElementById('table-responsive').attachEvent('on'+mousewheelevt, scroll);
 //        } else {
 //          document.getElementById('table-responsive').addEventListener(mousewheelevt, scroll, true);
 //        }
 //      }
