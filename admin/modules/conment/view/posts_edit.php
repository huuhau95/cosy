...
<div class="content-wrapper">
	<div class="page-heading page-heading-md">
					...
					<span class="breadcrumb hidden-xs">
						...
						<a href="<?php echo base_url() . 'conment/conment/index'; ?>">Danh sách Conment</a> /
					</span>
					<span class="title">Thêm mới - chỉnh sửa bình luận</span>
				</h2>
							...
							<div class="tab-pane active" id="tab_detail">
								<div class="form-body">
									<div class="form-group ">
										...
										<input class="form-control" id="title" placeholder="Họ và tên" value="<?php if (isset($this->data['data']['name'])) {
