            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                  <li class="active" style="display:none"><a href="#revenue-chart" data-toggle="tab"><?php echo lang('image'); ?></a></li>
                  <li class="" style="display:none"><a href="#sales-chart" data-toggle="tab"><?php echo lang('file'); ?></a></li>
                </ul>
                  ...
                  <div class="chart tab-pane active" id="revenue-chart" style="position: relative;">
                    <form id="form-uploads-ajax" enctype="multipart/form-data" method="post">
                      <div class="option_media">
                        ...
                        <button class="btn btn-info refesh" type="button" style="display:none">
  ...
  <div id="modelDeleteAll" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="" id="agree_del_all_post" class="btn btn-primary"><?php echo lang('agree');?></a>
