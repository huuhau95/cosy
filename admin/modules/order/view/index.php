      ...
      <div class="page-body-render" id="content">
        ...
        <div class="page-shipment">
          <div class="page-heading page-heading-md">
            <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-cart-arrow-down"></i> </span><span class="title">Danh sách đơn hàng</span></h2>
                      ...
                      <table class="table table-hover vert-align order-list" id="datatable">
                        <thead>
                          <tr>
                            ...
                            <th>Giao hàng</th>
                            <th>COD</th>
                            <th style="text-align: right;">Thu hộ</th>
                          </tr>
                        ...
                        <tbody>
                          ...
                          if (!empty($this->data['data_order'])) {
                            foreach ($this->data['data_order'] as $key => $value) {
                             ...
                             <td>
                              <span class="label label-warning">Chưa thu tiền</span>
                            </td>
