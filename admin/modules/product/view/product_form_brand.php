								...
								if (!empty($this->data['data_brand'])) {
									...
									<li>
										...
										<span class="avatar_brand preview img-wrapper" data-id="<?php echo $value['id'];?>">
											...
											<!-- http://truongnguyen.tk/admin/tmp/public/plugins/image_tools/timthumb.php?src=http://truongnguyen.tk/admin/tmp/cdn/bullbasaur1600.png&amp;h=100&amp;w=150&amp;zc=2 -->
											<?php 
										}
										?>
									</span>
...
<!-- <div class="left_type">
		...
		<div class="controls  next-popover__container--full-width">
			<div>
				<div class="next-field__connected-wrapper btn-group btn-group-filter">
					<input type="text" size="30" placeholder="Nhập loại sản phẩm" id="product_type" class="form-control next-input next-field--connected input-product_type">
					<a class="btn btn-default" style="color: #555;border-left: 0 none;" id="btn-toggle-popover-product_type">
