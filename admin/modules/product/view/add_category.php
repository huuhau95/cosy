        				...
        				<!-- <h2 class="header__main">
                                    ...
                                    <h2 class="header__main">
                                        <span class="breadcrumb hidden-xs">
                                            ...
                                            <a href="<?php echo base_url() . 'product/category/index'; ?>">Danh sách danh mục</a> /
                                        </span>
                                                   ...
                                                   <section class="content">
                                                      ...
                                                      <div class="row">
                                                         <div class="col-md-4 col-lg-3 margin-md-bottom">
                                                            ...
                                                            <p class="text-muted">- Danh mục sản phẩm dùng để nhóm các sản phẩm cùng loại với nhau</p>
                                                            <p class="text-muted">- Phân loại các danh mục con với tùy chọn <span style="font-weight: bold;">Danh mục gốc</span></p>
                                                            <p class="text-muted">- Sau khi hoàn thành bạn có thể <a href="<?php echo base_url() . 'product/product/add'; ?>">tạo sản phẩm</a> và phân loại</p>
                                                        </div>
...
?>
                           ...
                           <div class="row">
                              <div class="col-md-4 col-lg-3 margin-md-bottom">
                                <h4>Hình ảnh</h4>
                                <p class="text-muted">Bạn chọn một ảnh làm ảnh đại diện cho danh mục và một ảnh để hiển thị dạng nền</p>
                            </div>
                                                ...
                                                <div class="modal-image-choose" style="width: 50%;float: left;">
                                                   ...
                                                   <div class="text-center">
                                                    <a class="text-center" data-toggle="modal" data-target="#myModalPages">
                                                        ...
                                                        <input type="hidden" class="hidden_thumb_pages" name="hidden_thumb_pages" value="<?php if (isset($this->data['data']['avatar'])) {
	echo $this->data['data']['avatar'];
}
?>"/>
                                                    </a>
                                            ...
                                            <div class="modal-image-choose" style="width: 50%;float: left">
                                               ...
                                               <div class="text-center">
                                                <a class="text-center" data-toggle="modal" data-target="#myModalCover">
                                                    ...
                                                    <input type="hidden" class="background" name="background" value="<?php if (isset($this->data['data']['background'])) {
	echo $this->data['data']['background'];
}
?>"/>
                                                </a>
