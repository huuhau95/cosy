      ...
      <div class="page-body-render" id="content">
        ...
        <div class="page-shipment">
          <div class="page-heading page-heading-md">
            <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-cubes"></i> </span><span class="title">Danh sách sản phẩm</span></h2>
                      ...
                      <table class="table table-hover vert-align order-list" id="datatable">
                        ...
                        <tbody>
                          ...
                          <tr class="is-archived odd" role="row" style="text-align: center;">
                            ...
                            <td>
                              <a href="<?php echo base_url().'product/product/edit/'.$value['id'];?>"><?php echo $value['code'];?></a>
                            </td>
                            <td>
                            ...
                            <td><span>
                              <?php
                                if($value['brand']!="" && isset($value['brand'])){
                                    foreach ($this->data['brand'] as $key1 => $brand) {
                                        if (preg_match('/'.$brand['id'].'/',$value['brand'],$matches)) {
                                            ?>
                              <?php echo "<img src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url_cloud().'cdn/'.$brand['avatar'].'&h=25&w=25&zc=2'."'>"; ?>
                              <?php
                                }
                                }
                                }
                            ...
                            <td class="total" style="text-align: center;">
                              <?php 
                                if ($value['status']==1) {
                                echo "  <span  class='label label-sm label-success toan' status ='0' id_status=".$value['id']."><i class='fa fa-check' aria-hidden='true'></i> </span>";
                                }else{
                                echo "  <span  class='label label-sm label-warning toan'status ='1' id_status=".$value['id']."><i class='fa fa-times' aria-hidden='true'></i></span>";
                                }
                                ?>
                            </td>
                            <td colspan="" rowspan="" headers="">
                              <a id="ok" href="<?php echo base_url()?>/product/product/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a> 
