    ...
    <div class="page-body">
      ...
      <div class="page-shipment">
        <div class="page-heading page-heading-md">
          <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-cube"></i> </span><span class="title">Danh mục sản phẩm</span></h2>
            ...
            <div class="filters">
              <ul class="filter-tab-list" id="filter-tab-list">
                <li class="filter-tab-item">
                  <a href="" class="filter-tab filter-tab-active show-all-items">Tất cả danh mục sản phẩm</a>
                </li>
