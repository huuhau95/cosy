...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
    <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-file-image-o"></i> </span><span class="title">Danh sách ảnh quảng cáo</span></h2>
                                ...
                                <table class="table table-hover vert-align order-list" id="datatable">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Tiêu đề quảng cáo</th>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($this->data['data'])) {
                                            ...
                                            <td class="sorting_1" style="width: 300px;"><a href="<?php echo base_url().'add/add/edit/'.$value['id'];?>"><?php echo stripslashes($value['title']);?></td></a>
