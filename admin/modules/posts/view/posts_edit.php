										...
										<div class="tab-pane active" id="tab_detail">
											<div class="form-body">
												<div class="form-group ">
													...
													<input class="form-control" id="title" placeholder="<?php echo lang('maximum_posts'); ?>" value="<?php if (isset($this->data['data']['title'])) {
												...
												<div class="form-group ">
													...
													<textarea class="form-control" rows="4" id="description" placeholder="<?php echo lang('description_required'); ?>" data-counter="300" name="description" cols="50"><?php if (isset($this->data['data']['description'])) {
														echo stripslashes($this->data['data']['description']);
													}
													?></textarea>
												</div>
												<div class="form-group ">
													...
													<textarea name="content" id="mytextarea" name="content">
														<?php if (isset($this->data['data']['content'])) {
												...
												<div class="form-group ">
													...
													<input class="form-control" id="tags" placeholder="<?php echo lang('tags'); ?>" value="<?php if (isset($this->data['data']['tags'])) {
														echo $this->data['data']['tags'];
													}
													?>" name="tags" type="text">
												</div>
																...
																<div class="scf-checkbox-wrap">
																	<span class="dis-block">
																		<label>
																			...
																			<input type="checkbox" name="show_contact_form" id="show_contact_form" value="true" <?php if (isset($this->data['data']['hot']) && $this->data['data']['hot'] != "" && $this->data['data']['hot'] == 1) {
																				echo " checked";
																			}
																			?>> <?php echo lang('yes'); ?>
																		</label>
												...
												<div class="form-group">
													<div class="widget light bordered meta-boxes">
														<div class="widget-title">
															<h4><i class="fa fa-info-circle"></i>Tiêu chí bài viết </h4>
														</div>
														<div class="widget-body">
															<div class="meta-box check-box" data-slug="show_contact_form1">
																...
																<div class="scf-checkbox-wrap">
																	<span class="dis-block">
																		<label>
																			Bài viết quan tâm &nbsp;
																			<input type="checkbox" name="hot" id="show_contact_form1" value="1" <?php if (isset($this->data['data']['hot1']) && $this->data['data']['hot1'] != "" && $this->data['data']['hot1'] == 1) {
																				echo " checked";
																			}
																			?>> <?php echo lang('yes'); ?>
																		</label>
																...
																<div class="scf-checkbox-wrap">
																	<span class="dis-block">
																		<label>
																			Voucher phổ biến &nbsp;
																			<input type="checkbox" name="voucher" id="show_contact_form1" value="2" <?php if (isset($this->data['data']['hot1']) && $this->data['data']['hot1'] != "" && $this->data['data']['hot1'] == 2) {
																				echo " checked";
																			}
																			?>> <?php echo lang('yes'); ?>
																		</label>
								...
								<div>
									...
									<div class="modal-file-choose">
										<div class="text-center">
											...
											<input type="hidden" class="hidden_thumb_pages1" name="hidden_thumb_pages1" value="<?php if (isset($this->data['data']['file_url'])) {
									...
									<div class="modal-image-choose">
										<div class="text-center">
											<a class="text-center" data-toggle="modal" data-target="#myModalPages">
												...
												<input type="hidden" class="hidden_thumb_pages" name="hidden_thumb_pages" value="<?php if (isset($this->data['data']['thumbnail'])) {
													echo $this->data['data']['thumbnail'];
												}
												?>"/>
											</a>
											<h5 class="text-center"><a href="" class="del-image-choose-pages" style="color: #FF5722;font-weight:bold;"><i class="fa fa-trash-o" aria-hidden="true"></i> <?php echo lang('delete'); ?> </a></h5>
